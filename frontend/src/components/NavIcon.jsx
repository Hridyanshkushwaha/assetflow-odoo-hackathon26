const paths = {
  ...
  allocations: 'M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4',
  ...
  audits: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z',
...
export default function NavIcon({ to, className = 'h-[18px] w-[18px]' }) {
  const d = paths[keyMap[to]] || paths.dashboard;
  return (
